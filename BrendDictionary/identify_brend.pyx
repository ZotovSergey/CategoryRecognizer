...
cpdef tuple identify_brend_and_dec_id(str sku_row, list brand_rightholders, list main_identifires, list main_limit_identifires, list add_limit_identifires, list excluding_identifires):
    ...
    :param excluding_identifires: список исключающих идентификаторов
    :param sku_row: SKU, по которому определяется бренд
    :return: обозначение бренда из brand_rightholders или пустая строка, если бренд не удается определить; главный решающий идентификатор; главный ограничивающий решающий
